...
| Import/export | Import from filesystem `grit-lib`, repair indexes, export for backup/debugging | read-write | `import_repository`, `repair_*`, `check_repository_consistency`, `export_repository` | Import is reachable-object based, not a full mirror of every unreachable object. |
